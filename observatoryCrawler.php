...
class observatoryCrawlerPluginRegister
{
	...
	public static function instance()
	{
		...
		{
			self::$instance = new observatoryCrawlerPluginRegister();
		}
	...
	{
		$plugin = new $class();
		if( ! is_a( $plugin, "observatoryCrawlerPlugin" ) )
		{
			print "$class is not a observatoryCrawlerPlugin. Can't register it.\n";
			return;
		}
...
abstract class observatoryCrawlerPlugin 
{
	protected $id = null;
...
abstract class observatoryCrawlerPluginRegexp extends observatoryCrawlerPlugin
{
...
abstract class observatoryCrawlerPluginRegexpCount extends observatoryCrawlerPlugin
{
	protected $regexp = null;
	protected $caseSensitive = true;
	protected $insideTags = true;
...
abstract class observatoryCrawlerPluginRegexpList extends observatoryCrawlerPlugin
{
	protected $regexp = null;
	protected $caseSensitive = true;
	protected $insideTags = true;
